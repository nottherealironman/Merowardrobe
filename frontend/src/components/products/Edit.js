...
class Edit extends Component {
	...
	componentWillMount(props){
		...
		console.log(this.props.data.product.title)
		this.state = {
						    ...
						    <div className={"tab-pane fade show "+this.state.tabs.tab1} id="product_info" role="tabpanel" aria-labelledby="product_info-tab">
						      <div className="product_add__form">
						        <Formik
						        	enableReinitialize
									initialValues={{
								        title: this.props.data.product.title ? this.props.data.product.title : '',
								        gender: this.props.data.product.gender ? this.props.data.product.gender : '',
								        category: this.props.data.product.category ? this.props.data.product.category : '',
								        subcategory: this.props.data.product.subcategory ? this.props.data.product.subcategory : '',
								        brand: this.props.data.product.brand ? this.props.data.product.brand : ''
								      }}
